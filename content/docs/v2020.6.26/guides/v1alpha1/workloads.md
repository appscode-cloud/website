...
You can find the full working demo in [examples folder](/docs/v2020.6.26/examples/workloads/statefulset.yaml). The section you should change for your own StatefulSet are:
