...
The job model is further divided into two categories. In the first category, the targeted resource is well known to Stash (example, a PVC). Hence, the Stash operator itself can create the required job to backup/restore the target. In the second category, Stash follows `Function-Task` model where the targeted resource is not known to Stash. In this case, the user creates some [Function](/docs/v2020.6.26/concepts/crds/function) which resembles a step of backup/restore process and a [Task](/docs/v2020.6.26/concepts/crds/task) which specifies the order of execution of these steps. Stash uses these `Function` and `Task` to generate the required job definition to backup/restore the target.
...
A Stash addon is a collection of [Functions](/docs/v2020.6.26/concepts/crds/function) and a [Task](/docs/v2020.6.26/concepts/crds/task) to backup & restore a specific resource.
...
<figure align="center">
  <img alt="Stash Addon Overview" src="/docs/v2020.6.26/images/guides/latest/addons/addon_overview.svg">
...
| ------------------------------------------------------- | ----------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| [PostgreSQL](/docs/v2020.6.26/addons/postgres/README)           | Backup & Restore PostgreSQL databases     | `9.6`, `10.2`, `10.6`, `11.1`, `11.2`                                                                                          |
| [Elasticsearch](/docs/v2020.6.26/addons/elasticsearch/README)   | Backup & Restore Elasticsearch databases  | `5.6`, `5.6.4`, `6.2`, `6.2.4`, `6.3`, `6.3.0`, `6.4`, `6.4.0`, `6.5`, `6.5.3`, `6.8`, `6.8.0`, `7.2`, `7.2.0`, `7.3`, `7.3.2` |
| [MySQL](/docs/v2020.6.26/addons/mysql/README)                   | Backup & Restore MySQL databases          | `5.7.25`, `8.0.3`, `8.0.14`                                                                                                    |
| [MongoDB](/docs/v2020.6.26/addons/mongodb/README)               | Backup & Restore MongoDB databases        | `3.4`, `3.4.17`, `3.4.22`, `3.6`, `3.6.8`, `3.6.13`, `4.0`, `4.0.3`, `4.0.5`, `4.0.11`, `4.1`, `4.1.4`, `4.1.7`, `4.1.13`      |
| [Percona XtraDB](/docs/v2020.6.26/addons/percona-xtradb/README) | Backup & Restore Percona XtraDB databases | `5.7`                                                                                                                          |
